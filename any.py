...
def create_responsive_gui():
    ...
    # Set the window size
    root.geometry("600x400")  # تأكد من أن هذه الأبعاد تناسب تصميم الواجهة
    ...
    img_label1.image = img1_tk  # احتفظ بالمرجع للصورة
    ...
    img_label2.image = img2_tk  # احتفظ بالمرجع للصورة
